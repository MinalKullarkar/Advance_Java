...
import com.jspiders.springbootapp.response.StudentResponse;
import com.jspiders.springbootapp.service.StudentService;
...
public class StudentController {
	...
	@GetMapping("/student/{email}/{name}")
	public ResponseEntity<StudentResponse> getStudentByEmailandName(@PathVariable String email, @PathVariable String name){
